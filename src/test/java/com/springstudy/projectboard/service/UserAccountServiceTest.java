...
class UserAccountServiceTest {
    ...
    @DisplayName("존재하는지 않는 회원 ID를 검색하면, 비어있는 Optional로 반환한다.")
    @Test
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("ihj");
        UserAccount savedUserAccount = createSigningUpUserAccount("ihj");
