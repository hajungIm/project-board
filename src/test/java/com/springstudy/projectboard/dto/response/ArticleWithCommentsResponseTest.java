package com.springstudy.projectboard.dto.response;
...
class ArticleWithCommentsResponseTest {
    ...
    @DisplayName("게시글 + 댓글 dto를 api 응답으로 변환할 때, 댓글 부모 자식 관계 깊이(depth)는 제한이 없다.")
    @Test
    void givenArticleWithCommentsDto_whenMapping_thenOrganizesParentAndChildCommentsWithoutDepthLimit() {
        ...
        while (iterator.hasNext()) {
            ...
            assertThat(articleCommentResponse)
                    ...
                    .hasFieldOrPropertyWithValue("parentCommentId", i == 1L ? null : i - 1)
    ...
    private ArticleCommentResponse createArticleCommentResponse(Long id, Long parentId, LocalDateTime createdAt) {
